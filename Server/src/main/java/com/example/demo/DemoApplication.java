...
//		 */
//		server.addEventListener("login", UserBean.class, new DataListener<UserBean>() {
//			//将Service注入Web层
//			@Autowired
//			public UserService userService;
//
//			@Override
//			public void onData(SocketIOClient client, UserBean data, AckRequest ackRequest) {
//				System.out.println("接收到客户端login消息：code = " + data.getUsername() + ",body = " + data.getIduser());
//				// check is ack requested by client, but it's not required check
//				if (ackRequest.isAckRequested()) {
//					// send ack response with data to client
//					ackRequest.sendAckData("已成功收到客户端登录请求", "yeah");
//					ArrayList<UserBean> userBean= userService.loginIn(1,"Nancy");
//				}
//				// 向客户端发送消息
